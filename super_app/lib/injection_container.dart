    ...
    () =>
        Dio(
            BaseOptions(
              ...
              connectTimeout: const Duration(seconds: 10), // kaç saniye boyuncu bağlantıda kalınır
              receiveTimeout: const Duration(seconds: 10), // bağlandıktan sonra kaç saniye bekleyeceğiz
            ),
          )
          ..interceptors.addAll([
            ApiInterceptor(),
